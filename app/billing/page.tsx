...
export default function BillingPage() {
  ...
  const handleManageClick = async () => {
    await alert({
      ...
      message: "Please reach out to journalbudsupport@gmail.com to manage or cancel your existing subscription.",
      variant: "safe"
    });
  };
  ...
  return (
    <div className="animate-in fade-in duration-500 max-w-5xl mx-auto pb-16 space-y-12">
      ...
      <section className="fade-slide-up" style={{ animationDelay: "100ms" }}>
        ...
        <div className="px-8 pb-8 -mt-6 bg-zinc-50 dark:bg-[#0B0F14] border-x border-b border-zinc-200 dark:border-[#111827] rounded-b-2xl shadow-xl">
