  ...
  return (
    <div className="min-h-screen bg-black text-[#EAEAEA] p-8 md:p-16 max-w-4xl mx-auto selection:bg-[#D4AF37]/30 animate-in fade-in duration-500">
      ...
      <div className="space-y-10 text-base leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-[#D4AF37] mb-3">2. How We Store Your Data</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-[#D4AF37] mb-3">3. We Do Not Sell Your Data</h2>
          <p className="p-5 bg-[#10B981]/10 border border-[#10B981]/20 rounded-2xl text-[#10B981]/90 font-medium">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-[#D4AF37] mb-3">4. Communications</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-[#D4AF37] mb-3">5. Data Deletion</h2>
