...
export default function PrivacyPage() {
  return (
    <div className="min-h-screen bg-black text-zinc-300 p-8 md:p-16 max-w-4xl mx-auto selection:bg-emerald-500/30 animate-in fade-in duration-500">
      <div className="mb-10">
        <Link href="/" className="inline-flex items-center gap-2 text-sm text-emerald-500 hover:text-emerald-400 pb-2 transition-colors">
          <ArrowLeft size={16} /> Back to App
        </Link>
        <h1 className="text-4xl md:text-5xl font-bold text-white mt-4 mb-2 tracking-tight">Privacy Policy</h1>
        <p className="text-zinc-500 font-medium">Last Updated: March 2026</p>
      </div>

      <div className="space-y-10 text-base leading-relaxed">
        <section>
          <h2 className="text-2xl font-semibold text-emerald-400 mb-3">1. What We Collect</h2>
          <p>We only collect the absolute minimum data required to keep the application functioning seamlessly for you:</p>
          <ul className="list-disc pl-6 mt-4 space-y-3 text-zinc-400">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-emerald-400 mb-3">2. How We Store Your Data</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-emerald-400 mb-3">3. We Do Not Sell Your Data</h2>
          <p className="p-5 bg-emerald-500/10 border border-emerald-500/20 rounded-xl text-emerald-100">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-emerald-400 mb-3">4. Communications</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-emerald-400 mb-3">5. Data Deletion</h2>
