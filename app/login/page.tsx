  ...
  return (
    <div className="min-h-screen bg-[#0B0F14] flex flex-col md:flex-row overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 md:p-12 relative">
        <Link href={forceSignup ? "/login" : "/"} className="absolute top-6 left-6 lg:left-12 flex items-center gap-2 text-zinc-500 hover:text-white transition-colors font-bold text-sm">
