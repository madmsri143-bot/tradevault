...
function AIStatusLine({ lines }: { lines: string[] }) {
  ...
  return (
    <div className="flex items-center gap-2 font-mono text-xs md:text-sm text-[#C9A646]/80 min-h-[1.5em]">
      <span className="w-1.5 h-1.5 rounded-full bg-[#C9A646] animate-pulse shrink-0" />
      <span>{text}</span>
      <span className="animate-blink text-[#C9A646]">▊</span>
    </div>
  );
}
...
function ChatBubble({ sender, message, delay = "0ms", variant = "default" }: {
  ...
  return (
    <div className="animate-chat-bubble" style={{ animationDelay: delay }}>
      <p className={`text-[10px] uppercase tracking-widest font-bold mb-1.5 ${isAI ? "text-[#C9A646]" : "text-[#9CA3AF]"}`}>
        {sender}
      </p>
      <div className={`px-4 py-3 rounded-2xl text-sm leading-relaxed max-w-xs ${isAI
        ? "bg-[#C9A646]/10 border border-[#C9A646]/20 text-zinc-200"
        : "bg-white/5 border border-[#111827] text-[#9CA3AF]"}`}>
        {message}
      </div>
    </div>
  );
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0B0F14] text-[#E5E7EB] selection:bg-[#C9A646]/30 overflow-x-hidden">

      {/* ── DYNAMIC BACKGROUND ── */}
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        <div className="absolute -top-[10%] -left-[10%] w-[50%] h-[50%] rounded-full bg-[#C9A646]/5 blur-[150px]"
      ...
      <nav className="relative z-50 flex items-center justify-between px-6 py-5 max-w-7xl mx-auto">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-medium text-[#9CA3AF]">
          <a href="#how-it-works" className="hover:text-[#E5E7EB] transition-colors duration-300">How It Works</a>
          <a href="#features" className="hover:text-[#E5E7EB] transition-colors duration-300">Features</a>
          <a href="#pricing" className="hover:text-[#E5E7EB] transition-colors duration-300">Pricing</a>
          <Link href="/demo" className="hidden sm:flex text-sm font-medium text-[#9CA3AF] hover:text-[#C9A646] transition-colors items-center gap-1.5">
            <Play size={14} className="text-[#C9A646]" /> Demo
          </Link>
        </div>

        <div className="flex items-center gap-4">
          <Link href="/login" className="text-sm font-medium text-[#9CA3AF] hover:text-[#E5E7EB] transition-colors">
            Login
          </Link>
          <Link href={ctaHref}
            className="bg-[#C9A646] text-black px-5 py-2.5 rounded-full text-sm font-bold hover:bg-[#C9A646] hover:shadow-[0_0_25px_rgba(212,175,55,0.4)] transition-all duration-300">
            Get Started
          </Link>
        </div>
      </nav>
      ...
      <section className="relative z-10 pt-16 md:pt-24 pb-24 px-6 max-w-5xl mx-auto flex flex-col items-center text-center">
        ...
        <div className="space-y-8 fade-slide-up mt-8">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#C9A646]/10 border border-[#C9A646]/20 text-[#C9A646] text-[11px] font-bold uppercase tracking-[0.15em] mx-auto">
            <span className="w-1.5 h-1.5 rounded-full bg-[#C9A646] animate-pulse" />
            AI-Powered Trading Companion
          </div>

          <h1 className="text-5xl md:text-[5.5rem] font-black tracking-tight leading-[1.05]">
            You Trade.<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C9A646] via-[#C9A646] to-[#C9A646] bg-[length:200%_auto] animate-gradient-x">
              Your Buddy
            </span>
            <br />Understands.
          </h1>
          ...
          <div className="flex flex-col items-center gap-4 pt-4">
            <Link href={ctaHref}
              className="group px-8 py-4 bg-gradient-to-r from-[#C9A646] to-[#C9A646] text-[#0B0B0F] font-black rounded-2xl flex items-center justify-center gap-2.5 hover:shadow-[0_0_40px_rgba(212,175,55,0.4)] hover:-translate-y-1 transition-all duration-300 text-lg">
              Start With Your Trading Buddy
              <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform border-[#0B0B0F]" />
            </Link>
            <p className="text-[11px] font-semibold text-[#9CA3AF] uppercase tracking-[0.15em]">
          ...
          <div className="flex items-center justify-center gap-8 pt-6">
            <div className="flex items-center gap-2 text-[11px] font-bold uppercase tracking-widest text-[#9CA3AF]">
              <ShieldCheck size={15} className="text-[#C9A646]" /> 100% Secure
            </div>
            <div className="flex items-center gap-2 text-[11px] font-bold uppercase tracking-widest text-[#9CA3AF]">
              <Zap size={15} className="text-[#C9A646]" /> 2-Second Analysis
            </div>
          </div>
        </div>
      ...
      <section className="py-16 md:py-20 px-6 relative z-10 border-t border-[#111827]">
        <div className="max-w-6xl mx-auto">
          <div className="reveal text-center mb-20">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#C9A646]/8 border border-[#C9A646]/15 text-[#C9A646] text-[11px] font-bold uppercase tracking-[0.15em] mb-6">
              <Eye size={14} /> Always Observing
            </div>
            <h2 className="text-4xl md:text-6xl font-black tracking-tight leading-tight">
              It Watches What<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C9A646] to-[#C9A646]">You Miss</span>
            </h2>
          </div>
            ...
            <div className="reveal grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                ...
                const colors: Record<string, string> = {
                  ...
                  emerald: "from-[#C9A646]/10 to-[#C9A646]/5 border-[#C9A646]/15 text-[#C9A646]",
                ...
                return (
                  <div key={i}
                    ...
                    <h4 className="font-bold text-[#E5E7EB] text-sm mb-1">{f.title}</h4>
      ...
      <section id="how-it-works" className="py-16 md:py-20 px-6 relative z-10 bg-gradient-to-b from-[#0B0F14] via-[#0D1117] to-[#0B0F14] border-t border-[#111827]">
        <div className="max-w-6xl mx-auto">
          <div className="reveal text-center mb-20">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-zinc-700/20 border border-zinc-600/30 text-[#E5E7EB] text-[11px] font-bold uppercase tracking-[0.15em] mb-6">
              <Upload size={14} /> Core Feature
            </div>
            <h2 className="text-4xl md:text-6xl font-black tracking-tight leading-tight">
              Just Drop Your<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C9A646] to-[#C9A646]">Trades</span>
            </h2>
            <p className="text-[#9CA3AF] text-lg mt-4 max-w-lg mx-auto">
          ...
          <div className="reveal max-w-3xl mx-auto">
            <div className="relative group">
              <div className="absolute -inset-1 bg-gradient-to-r from-[#C9A646]/20 via-[#C9A646]/20 to-[#C9A646]/20 rounded-[2rem] blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
              ...
              <div className="relative bg-[#11161D]/80 backdrop-blur-xl border border-white/8 rounded-[2rem] shadow-2xl overflow-hidden">
                ...
                <div className="flex items-center gap-2 px-6 py-4 border-b border-[#111827]">
                  ...
                  <span className="ml-4 text-[11px] font-mono text-[#9CA3AF]">JournalBud — Trade Extraction</span>
                </div>
                ...
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="md:w-1/2 p-8 border-b md:border-b-0 md:border-r border-[#111827] flex flex-col items-center justify-center relative min-h-[300px]">
                    ...
                    <div className="flex gap-3 mb-6">
                      {[
                        ...
                        <div key={i} className="flex flex-col items-center gap-1.5">
                          <div className={`w-11 h-11 rounded-xl flex items-center justify-center transition-all duration-500 ${mockStep >= 1 ? "bg-[#C9A646]/15 border border-[#C9A646]/30" : "bg-white/5 border border-[#111827]"}`}>
                            <f.icon size={18} className={mockStep >= 1 ? "text-[#C9A646]" : "text-[#9CA3AF]"} />
                          </div>
                    ...
                    <div className={`w-20 h-20 rounded-2xl flex items-center justify-center transition-all duration-700 ${mockStep === 0 ? "bg-white/5 border-2 border-dashed border-[#111827]" :
                        mockStep === 1 ? "bg-[#C9A646]/15 border-2 border-[#C9A646]/40 animate-pulse" :
                          "bg-[#C9A646]/15 border-2 border-[#C9A646]/40"}`}>
                      {mockStep === 0 ? <Upload size={32} className="text-[#9CA3AF]" /> :
                        mockStep === 1 ? <ScanLine size={32} className="text-[#C9A646]" /> :
                          <Check size={32} className="text-[#C9A646]" />}
                    </div>

                    <p className="text-xs font-bold uppercase tracking-[0.15em] text-[#9CA3AF] mt-4">
                      {mockStep === 0 ? "Drop your trade history" : mockStep === 1 ? "AI scanning document..." : "✓ Data extracted"}
                    </p>

                    {/* Scan line */}
                    {mockStep === 1 && (
                      <div className="absolute top-0 left-0 w-full h-[2px] bg-[#C9A646] shadow-[0_0_20px_#C9A646] animate-[scan_1.8s_ease-in-out_infinite]" />
                    )}
                  </div>
                  ...
                  <div className="md:w-1/2 p-6 md:p-8 flex flex-col">
                    <div className="flex items-center justify-between mb-5">
                      <h3 className="font-bold text-sm text-[#C9A646] flex items-center gap-2">
                    ...
                    <div className="space-y-3 flex-1">
                      {[
                        ...
                        <div key={i} className="space-y-1">
                          <p className="text-[10px] uppercase text-[#9CA3AF] font-bold tracking-wider">{field.label}</p>
                          <div className={`w-full h-9 bg-[#0B0E13] border rounded-xl px-3 flex items-center transition-all duration-700 ${mockStep >= 2
                            ...
                            {mockStep >= 2 && (
                              <span className={`text-xs font-bold ${field.color === "red" ? "text-red-400" : field.color === "emerald" ? "text-amber-400" : "text-[#E5E7EB]"}`}>
                                {field.value}
                              </span>
                            )}
                          </div>
                    ...
                    <div className={`mt-5 w-full h-10 rounded-xl flex items-center justify-center font-bold text-xs transition-all duration-500 ${mockStep >= 2
                        ? "bg-[#C9A646] text-black shadow-[0_0_20px_rgba(201,166,70,0.2)]"
      ...
      <section id="features" className="py-16 md:py-20 px-6 relative z-10 border-t border-[#111827]">
        <div className="max-w-6xl mx-auto">
          <div className="reveal text-center mb-20">
            <h2 className="text-4xl md:text-6xl font-black tracking-tight leading-tight">
              Raw Trades →<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C9A646] to-amber-300">Real Awareness</span>
            </h2>
            <p className="text-[#9CA3AF] text-lg mt-4 max-w-lg mx-auto">
          ...
          <div className="reveal grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
            {[
              { label: "Win Rate", value: "70.5%", sub: "+5.2% vs last month", color: "#C9A646" },
              { label: "Profit Factor", value: "2.41", sub: "Above breakeven", color: "#C9A646" },
              ...
              <div key={i} className="group bg-[#11161D]/60 backdrop-blur-sm border border-[#111827] rounded-2xl p-5 hover:border-white/15 hover:bg-[#11161D] transition-all duration-300">
                <p className="text-[10px] uppercase font-bold tracking-[0.15em] text-[#9CA3AF] mb-2">{m.label}</p>
          ...
          <div className="reveal grid grid-cols-1 lg:grid-cols-3 gap-6">
            {/* PnL Chart mock */}
            <div className="lg:col-span-2 bg-[#11161D]/60 backdrop-blur-sm border border-[#111827] rounded-2xl p-6 relative overflow-hidden group hover:border-[#111827] transition-all">
              <div className="flex items-center justify-between mb-6">
                <h4 className="text-sm font-bold text-[#E5E7EB]">PnL Curve</h4>
                <span className="text-[10px] font-bold text-[#C9A646] bg-[#C9A646]/10 px-2 py-1 rounded-lg">+$2,847.30</span>
              </div>
            ...
            {/* Emotional states */}
            <div className="bg-[#11161D]/60 backdrop-blur-sm border border-[#111827] rounded-2xl p-6 hover:border-[#111827] transition-all">
              <h4 className="text-sm font-bold text-[#E5E7EB] mb-5">Emotional States</h4>
              <div className="space-y-4">
                {[
                  { emotion: "Confident", pct: 45, color: "#C9A646" },
                  { emotion: "Calm", pct: 25, color: "#C9A646" },
                  { emotion: "Anxious", pct: 18, color: "#F59E0B" },
                  { emotion: "Frustrated", pct: 12, color: "#EF4444" },
                ].map((e, i) => (
                  <div key={i}>
                    <div className="flex justify-between text-xs mb-1.5">
                      <span className="font-semibold text-[#9CA3AF]">{e.emotion}</span>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="reveal grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#C9A646]/8 border border-[#C9A646]/15 text-[#C9A646] text-[11px] font-bold uppercase tracking-[0.15em]">
                <Brain size={14} /> Big Selling Point
              </div>
              <h2 className="text-4xl md:text-5xl font-black tracking-tight leading-tight">
                Your Week,<br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C9A646] to-amber-300">Explained by AI</span>
              </h2>
              ...
              <Link href={ctaHref}
                className="inline-flex items-center gap-2 text-sm font-bold text-[#C9A646] hover:underline group">
            ...
            <div className="reveal relative">
              <div className="absolute -inset-4 bg-[#C9A646]/5 blur-3xl rounded-full" />
              <div className="relative bg-[#11161D]/80 backdrop-blur-xl border border-[#111827] rounded-2xl p-6 shadow-2xl space-y-5">
                <div className="flex items-center justify-between pb-4 border-b border-[#111827]">
                  <div>
                    <h4 className="font-bold text-[#E5E7EB] text-sm">Weekly AI Report</h4>
                    <p className="text-[11px] text-[#9CA3AF] mt-0.5">Mar 17 — Mar 23, 2026</p>
                  </div>
                    <BrainCircuit size={18} className="text-[#C9A646] animate-pulse" />
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-xs font-bold text-[#E5E7EB]">Top Mistake: Emotional Trading</p>
                      <p className="text-[11px] text-[#9CA3AF] mt-0.5">4 trades entered after consecutive losses — classic revenge pattern</p>
                    </div>
                  </div>

                  <div className="flex gap-3">
                    <div className="w-8 h-8 shrink-0 rounded-lg bg-[#C9A646]/10 border border-[#C9A646]/20 flex items-center justify-center">
                      <Target size={14} className="text-[#C9A646]" />
                    </div>
                    <div>
                      <p className="text-xs font-bold text-[#E5E7EB]">Advice: Stick to Your Plan</p>
                      <p className="text-[11px] text-[#9CA3AF] mt-0.5">Your planned entries have 78% win rate vs 31% for impulse trades</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-xs font-bold text-[#E5E7EB]">Discipline Score</p>
                      <p className="text-[11px] text-[#9CA3AF] mt-0.5">You scored <span className="text-amber-400 font-bold">20/100</span> — significant room for growth</p>
                    </div>
                  </div>
                </div>

                <div className="bg-[#0B0E13] rounded-xl p-4 border border-[#111827]">
                  <p className="text-[10px] uppercase tracking-wider text-[#9CA3AF] font-bold mb-2">AI Summary</p>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="reveal grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-2 lg:order-1 relative">
              <div className="absolute -inset-4 bg-[#C9A646]/5 blur-3xl rounded-full" />
              <div className="relative bg-[#11161D]/80 backdrop-blur-xl border border-[#111827] rounded-2xl p-6 shadow-2xl space-y-4">
                <h4 className="font-bold text-[#E5E7EB] text-sm flex items-center gap-2">
                  <Target size={16} className="text-[#C9A646]" /> Daily Targets
                </h4>

                {[
                  { label: "Max 3 trades per day", current: "2/3", pct: 66, status: "On track", color: "#C9A646" },
                  ...
                  { label: "No revenge trading", current: "Clean", pct: 100, status: "✓ Clear", color: "#C9A646" },
                ].map((g, i) => (
                  <div key={i} className="bg-[#0B0E13] border border-[#111827] rounded-xl p-4 space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-bold text-[#E5E7EB]">{g.label}</span>
            ...
            <div className="order-1 lg:order-2 space-y-6">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#C9A646]/10 border border-[#C9A646]/20 text-[#C9A646] text-[11px] font-bold uppercase tracking-[0.15em]">
                <Flame size={14} /> Psychology Engine
              </div>
              <h2 className="text-4xl md:text-5xl font-black tracking-tight leading-tight">
                Discipline,<br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C9A646] to-[#C9A646]">Engineered</span>
              </h2>
              <p className="text-[#9CA3AF] text-base leading-relaxed max-w-md">
                Set daily targets, drawdown limits, and trading rules. JournalBud enforces them and tracks your compliance automatically.
              </p>
              <div className="bg-[#0B0E13]/50 border border-[#111827] rounded-xl px-5 py-4">
                <p className="text-sm text-[#E5E7EB] leading-relaxed font-medium italic">
                  "You don&apos;t rise to your goals.<br />
                  <span className="text-[#C9A646] font-bold not-italic">You fall to your system."</span>
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="reveal text-center space-y-4 mb-16">
            <h2 className="text-4xl md:text-5xl font-black tracking-tight leading-tight">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C9A646] to-[#C9A646]">Profitable Minds</span>
            </h2>
            <p className="text-[#9CA3AF] text-lg">Choose a path that fits your trading journey.</p>
          </div>

          <div className="reveal grid grid-cols-1 md:grid-cols-2 gap-8 relative">
            {/* Free Plan */}
            <div className="bg-[#11161D]/60 backdrop-blur-sm border border-[#111827] p-8 rounded-[2rem] space-y-8 flex flex-col group hover:border-[#111827] transition-all duration-300">
              <div className="space-y-2">
                <h3 className="text-lg font-bold text-[#9CA3AF]">Standard Plan</h3>
                <p className="text-3xl font-black italic">Free <span className="text-sm text-[#9CA3AF] font-medium not-italic">/ forever</span></p>
              </div>
              ...
              <Link href="/signup?plan=free"
                className="w-full py-4 bg-zinc-800/80 hover:bg-zinc-700 text-[#E5E7EB] font-bold rounded-2xl transition-all text-center block">
                Start Free Plan
              </Link>
            </div>

            {/* Pro Plan */}
            <div className="bg-gradient-to-b from-[#11161D] to-[#0D1218] border-2 border-[#C9A646]/20 p-8 rounded-[2rem] space-y-8 relative overflow-hidden flex flex-col shadow-[0_0_60px_rgba(212,175,55,0.05)] transform md:-translate-y-4 hover:border-[#C9A646]/40 transition-all duration-300">
              <div className="absolute top-0 right-0 p-4">
                <span className="px-3 py-1 bg-gradient-to-r from-[#C9A646] to-[#C9A646] text-[#0B0B0F] text-[10px] font-black uppercase rounded-full tracking-widest shadow-[0_0_15px_rgba(212,175,55,0.3)]">
                  AI Engine Inside
                </span>
              </div>
              {/* Subtle glow */}
              <div className="absolute -top-20 -right-20 w-40 h-40 bg-[#C9A646]/10 rounded-full blur-3xl pointer-events-none" />
              <div className="space-y-2">
                <h3 className="text-lg font-bold text-[#C9A646]">Professional Access</h3>
                <p className="text-3xl font-black">$2.99 <span className="text-sm text-[#9CA3AF] font-medium">/ month</span></p>
                <p className="text-sm font-bold text-[#9CA3AF]">or <span className="text-[#E5E7EB]">$19.99</span> / year</p>
              </div>
              <ul className="space-y-4 flex-1">
              ...
              <div className="space-y-3">
                <Link href={ctaHref}
                  className="w-full py-4 bg-gradient-to-r from-[#C9A646] to-[#C9A646] text-[#0B0B0F] font-black rounded-2xl hover:shadow-[0_0_25px_rgba(212,175,55,0.4)] transition-all block text-center">
                  {user && hasUsedTrial ? "Upgrade to Pro" : "Start 7-Day Free Trial"}
                </Link>
                <Link href="/demo" className="w-full py-3 border border-[#111827] text-[#E5E7EB] font-bold rounded-2xl hover:bg-white/5 transition-all flex items-center justify-center gap-2">
                  <Play size={14} className="text-[#C9A646]" /> View Live Demo
                </Link>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="reveal text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black tracking-tight leading-tight">
              More Than a Tool.<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C9A646] via-[#C9A646] to-[#C9A646]">
                A Trading Buddy.
              </span>
            </h2>
          </div>
          ...
          <div className="reveal grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              { text: "You trade better after 2PM. Consider focusing your sessions.", icon: Clock, color: "#C9A646" },
              { text: "After 2 consecutive losses, take a 30-minute break. It works.", icon: Shield, color: "#C9A646" },
              { text: "Your win rate on XAUUSD is 82%. It's your strongest pair.", icon: Star, color: "#F59E0B" },
            ].map((tip, i) => (
              <div key={i}
                className="group relative bg-[#11161D]/60 backdrop-blur-sm border border-[#111827] rounded-2xl p-6 hover:border-white/15 transition-all duration-300 hover:-translate-y-1">
      ...
      <section className="py-16 md:py-20 px-6 relative z-10">
        <div className="reveal max-w-4xl mx-auto relative">
          {/* Background glow */}
          <div className="absolute inset-0 bg-gradient-to-r from-[#C9A646]/5 via-[#C9A646]/5 to-[#C9A646]/5 rounded-[3rem] blur-2xl" />
          ...
          <div className="relative bg-[#11161D]/60 backdrop-blur-xl border border-white/8 rounded-[3rem] p-12 md:p-20 text-center space-y-8 overflow-hidden">
            <div className="absolute -top-12 left-1/2 -translate-x-1/2 pointer-events-none opacity-40">
              <BrainCircuit size={64} className="text-[#C9A646] animate-pulse opacity-50" />
            </div>

            <div className="relative z-10 space-y-6 pt-8">
              <h2 className="text-4xl md:text-6xl font-black tracking-tight text-[#E5E7EB] leading-tight">
                Stop Trading Blind.
              </h2>
              ...
              <Link href={ctaHref}
                className="group mt-8 px-10 py-5 bg-gradient-to-r from-[#C9A646] to-[#C9A646] text-[#0B0B0F] font-black rounded-2xl hover:shadow-[0_0_50px_rgba(212,175,55,0.4)] hover:-translate-y-1 transition-all inline-flex items-center gap-3 text-lg">
                Start With Your Trading Buddy
      ...
      <footer className="border-t border-[#111827] py-12 px-6 relative z-10">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-3">
            <div className="w-7 h-7 rounded-lg bg-gradient-to-tr from-[#C9A646] to-amber-400 flex items-center justify-center">
              <LineChart size={14} className="text-black" />
            </div>
            <span className="text-sm font-brand font-bold text-[#9CA3AF]">JournalBud</span>
          </div>
...
function PricingTier({ feature, pro = false }: { feature: string; pro?: boolean }) {
  return (
    <li className="flex items-center gap-3">
      <div className={`w-5 h-5 rounded-full flex items-center justify-center shrink-0 ${pro ? "bg-[#C9A646]/20 text-[#C9A646]" : "bg-zinc-800 text-[#9CA3AF]"}`}>
        <Check size={14} strokeWidth={3} />
      </div>
      <span className={`text-sm ${pro ? "text-zinc-200 font-bold" : "text-[#9CA3AF]"}`}>{feature}</span>
    </li>
  );
}
...
function PricingLocked({ feature }: { feature: string }) {
  return (
    <li className="flex items-center gap-3 opacity-30 select-none">
      <div className="w-5 h-5 rounded-full border border-[#111827] flex items-center justify-center shrink-0">
        <Lock size={10} />
      </div>
      <span className="text-xs text-[#9CA3AF] line-through">{feature}</span>
    </li>
  );
}
