...
function ChatBubble({ sender, message, delay = "0ms", variant = "default" }: {
  ...
  return (
    <div className="animate-chat-bubble" style={{ animationDelay: delay }}>
      <p className={`text-[10px] uppercase tracking-widest font-bold mb-1.5 ${isAI ? "text-[#D4AF37]" : "text-zinc-600 dark:text-[#A0A0A0]"}`}>
        {sender}
      </p>
      <div className={`px-4 py-3 rounded-2xl text-sm leading-relaxed max-w-xs ${isAI
        ...
        : "bg-white/5 border border-zinc-200 dark:border-[rgba(212,175,55,0.15)] text-zinc-600 dark:text-[#A0A0A0]"}`}>
        {message}
      </div>
    </div>
  );
...
export default function LandingPage() {
  ...
  if (loading || user) return <div className="min-h-screen bg-zinc-50 dark:bg-[#0B0F14]" />;

  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-[#0B0F14] text-zinc-900 dark:text-[#EAEAEA] selection:bg-[#D4AF37]/30 overflow-x-hidden">
      ...
      <section className="relative z-10 pt-8 md:pt-10 pb-10 px-6 max-w-5xl mx-auto flex flex-col items-center text-center">
        ...
        <div className="space-y-4 fade-slide-up mt-2">
          ...
          <p className="text-lg md:text-xl text-zinc-600 dark:text-[#A0A0A0] max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col items-center gap-4 pt-4">
            ...
            <p className="text-[11px] font-semibold text-zinc-600 dark:text-[#A0A0A0] uppercase tracking-[0.15em]">
              No card. No setup. Just upload and begin.
            </p>
          </div>

          <div className="flex items-center justify-center gap-8 pt-6">
            <div className="flex items-center gap-2 text-[11px] font-bold uppercase tracking-widest text-zinc-600 dark:text-[#A0A0A0]">
      ...
      {/* ═══════════════════════════════════════
         ...
         ═══════════════════════════════════════ */}
      <section className="py-10 md:py-14 px-6 relative z-10 border-t border-zinc-200 dark:border-[#111827]">
            ...
            <div className="reveal grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                ...
                const colors: Record<string, string> = {
                  ...
                  muted: "from-white/5 to-transparent border-white/10 text-zinc-600 dark:text-[#A0A0A0]",
                };
                return (
                  <div key={i}
                    ...
                    <h4 className="font-bold text-zinc-900 dark:text-[#EAEAEA] text-sm mb-1">{f.title}</h4>
                    <p className="text-zinc-600 dark:text-[#A0A0A0] text-xs leading-relaxed">{f.desc}</p>
                  </div>
                );
              })}
            </div>
      ...
      {/* ═══════════════════════════════════════
         ...
         ═══════════════════════════════════════ */}
      <section id="how-it-works" className="py-10 md:py-14 px-6 relative z-10 bg-gradient-to-b from-[#0B0F14] via-[#0D1117] to-[#0B0F14] border-t border-zinc-200 dark:border-[#111827]">
        <div className="max-w-6xl mx-auto">
          <div className="reveal text-center mb-16">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-zinc-700/20 border border-zinc-600/30 text-zinc-900 dark:text-[#EAEAEA] text-[11px] font-bold uppercase tracking-[0.15em] mb-4">
            ...
            <p className="text-zinc-600 dark:text-[#A0A0A0] text-lg mt-4 max-w-lg mx-auto">
          ...
          <div className="reveal max-w-3xl mx-auto">
            <div className="relative group">
              ...
              <div className="relative bg-white dark:bg-[#11161D]/80 backdrop-blur-xl border border-white/8 rounded-[2rem] shadow-2xl overflow-hidden">
                {/* Top bar */}
                <div className="flex items-center gap-2 px-6 py-4 border-b border-zinc-200 dark:border-[#111827]">
                  <div className="flex gap-1.5">
                    <div className="w-3 h-3 rounded-full bg-red-500/60" />
                    <div className="w-3 h-3 rounded-full bg-amber-500/60" />
                    <div className="w-3 h-3 rounded-full bg-emerald-500/60" />
                  </div>
                  <span className="ml-4 text-[11px] font-mono text-zinc-600 dark:text-[#A0A0A0]">JournalBud — Trade Extraction</span>
                </div>

                <div className="flex flex-col md:flex-row">
                  {/* Left: Upload zone */}
                  <div className="md:w-1/2 p-8 border-b md:border-b-0 md:border-r border-zinc-200 dark:border-[#111827] flex flex-col items-center justify-center relative min-h-[300px]">
                    {/* Upload formats */}
                    <div className="flex gap-3 mb-6">
                      {[
                        ...
                        <div key={i} className="flex flex-col items-center gap-1.5">
                          <div className={`w-11 h-11 rounded-2xl flex items-center justify-center transition-all duration-500 ${mockStep >= 1 ? "bg-[#D4AF37]/15 border border-[#D4AF37]/30" : "bg-white/5 border border-zinc-200 dark:border-[rgba(212,175,55,0.15)]"}`}>
                            <f.icon size={18} className={mockStep >= 1 ? "text-[#D4AF37]" : "text-zinc-600 dark:text-[#A0A0A0]"} />
                          </div>
                    ...
                    {/* Status indicator */}
                    <div className={`w-20 h-20 rounded-2xl flex items-center justify-center transition-all duration-700 ${mockStep === 0 ? "bg-white/5 border-2 border-dashed border-zinc-200 dark:border-[#111827]" :
                        mockStep === 1 ? "bg-[#D4AF37]/15 border-2 border-[#D4AF37]/40 animate-pulse" :
                          "bg-[#D4AF37]/15 border-2 border-[#D4AF37]/40"}`}>
                      {mockStep === 0 ? <Upload size={32} className="text-zinc-600 dark:text-[#A0A0A0]" /> :
                        mockStep === 1 ? <ScanLine size={32} className="text-[#D4AF37]" /> :
                          <Check size={32} className="text-[#D4AF37]" />}
                    </div>

                    <p className="text-xs font-bold uppercase tracking-[0.15em] text-zinc-600 dark:text-[#A0A0A0] mt-4">
                  ...
                  <div className="md:w-1/2 p-6 md:p-8 flex flex-col">
                    ...
                    <div className="space-y-3 flex-1">
                      {[
                        ...
                        <div key={i} className="space-y-1">
                          <p className="text-[10px] uppercase text-zinc-600 dark:text-[#A0A0A0] font-bold tracking-wider">{field.label}</p>
                          <div className={`w-full h-9 bg-[#0B0E13] border rounded-2xl px-3 flex items-center transition-all duration-700 ${mockStep >= 2
                              ...
                              : "border-zinc-200 dark:border-[#111827]"}`}
                            style={{ transitionDelay: `${i * 100}ms` }}>
                            {mockStep >= 2 && (
                              <span className={`text-xs font-bold ${field.color === "red" ? "text-[#FF4D6D]" : field.color === "gold" ? "text-[#D4AF37]" : "text-zinc-900 dark:text-[#EAEAEA]"}`}>
                                {field.value}
                              </span>
                            )}
                          </div>
                    ...
                    <div className={`mt-5 w-full h-10 rounded-2xl flex items-center justify-center font-bold text-xs transition-all duration-500 ${mockStep >= 2
                        ...
                        : "bg-zinc-200 dark:bg-zinc-800/50 text-zinc-600"}`}>
      ...
      {/* ═══════════════════════════════════════
         ...
         ═══════════════════════════════════════ */}
      <section id="features" className="py-10 md:py-14 px-6 relative z-10 border-t border-zinc-200 dark:border-[#111827]">
        <div className="max-w-6xl mx-auto">
          <div className="reveal text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black tracking-tight leading-tight">
              Raw Trades →<br />
          ...
          <div className="reveal grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
            {[
              ...
              <div key={i} className="group bg-white dark:bg-[#11161D]/60 backdrop-blur-sm border border-zinc-200 dark:border-[rgba(212,175,55,0.15)] rounded-2xl p-5 hover:border-white/15 hover:bg-white dark:bg-[#11161D] transition-all duration-300">
                <p className="text-[10px] uppercase font-bold tracking-[0.15em] text-zinc-600 dark:text-[#A0A0A0] mb-2">{m.label}</p>
                <p className="text-2xl md:text-3xl font-black" style={{ color: m.color }}>{m.value}</p>
                <p className="text-[11px] text-zinc-600 dark:text-[#A0A0A0] mt-1">{m.sub}</p>
              </div>
            ))}
          </div>
          ...
          <div className="reveal grid grid-cols-1 lg:grid-cols-3 gap-6">
            {/* PnL Chart mock */}
            <div className="lg:col-span-2 bg-white dark:bg-[#11161D]/60 backdrop-blur-sm border border-zinc-200 dark:border-[rgba(212,175,55,0.15)] rounded-2xl p-6 relative overflow-hidden group hover:border-zinc-200 dark:border-[#111827] transition-all">
              <div className="flex items-center justify-between mb-6">
                <h4 className="text-sm font-bold text-zinc-900 dark:text-[#EAEAEA]">PnL Curve</h4>
            ...
            {/* Emotional states */}
            <div className="bg-white dark:bg-[#11161D]/60 backdrop-blur-sm border border-zinc-200 dark:border-[rgba(212,175,55,0.15)] rounded-2xl p-6 hover:border-zinc-200 dark:border-[#111827] transition-all">
              <h4 className="text-sm font-bold text-zinc-900 dark:text-[#EAEAEA] mb-5">Emotional States</h4>
                ...
                {[
                  ...
                  <div key={i}>
                    <div className="flex justify-between text-xs mb-1.5">
                      <span className="font-semibold text-zinc-600 dark:text-[#A0A0A0]">{e.emotion}</span>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="reveal grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-5">
              ...
              <p className="text-zinc-600 dark:text-[#A0A0A0] text-base leading-relaxed max-w-md">
            ...
            <div className="reveal relative">
              ...
              <div className="relative bg-white dark:bg-[#11161D]/80 backdrop-blur-xl border border-zinc-200 dark:border-[rgba(212,175,55,0.15)] rounded-2xl p-6 shadow-2xl space-y-5">
                <div className="flex items-center justify-between pb-4 border-b border-zinc-200 dark:border-[#111827]">
                  <div>
                    <h4 className="font-bold text-zinc-900 dark:text-[#EAEAEA] text-sm">Weekly AI Report</h4>
                    <p className="text-[11px] text-zinc-600 dark:text-[#A0A0A0] mt-0.5">Mar 17 — Mar 23, 2026</p>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-xs font-bold text-zinc-900 dark:text-[#EAEAEA]">Top Mistake: Emotional Trading</p>
                      <p className="text-[11px] text-zinc-600 dark:text-[#A0A0A0] mt-0.5">4 trades entered after consecutive losses — classic revenge pattern</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-xs font-bold text-zinc-900 dark:text-[#EAEAEA]">Advice: Stick to Your Plan</p>
                      <p className="text-[11px] text-zinc-600 dark:text-[#A0A0A0] mt-0.5">Your planned entries have 78% win rate vs 31% for impulse trades</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-xs font-bold text-zinc-900 dark:text-[#EAEAEA]">Discipline Score</p>
                      <p className="text-[11px] text-zinc-600 dark:text-[#A0A0A0] mt-0.5">You scored <span className="text-amber-600 dark:text-amber-400 font-bold">20/100</span> — significant room for growth</p>
                    </div>
                  </div>
                </div>

                <div className="bg-[#0B0E13] rounded-2xl p-4 border border-zinc-200 dark:border-[rgba(212,175,55,0.15)]">
                  <p className="text-[10px] uppercase tracking-wider text-zinc-600 dark:text-[#A0A0A0] font-bold mb-2">AI Summary</p>
                  <p className="text-xs text-zinc-600 dark:text-[#A0A0A0] leading-relaxed italic">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="reveal grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-2 lg:order-1 relative">
              <div className="absolute -inset-4 bg-[#D4AF37]/5 blur-3xl rounded-full" />
              <div className="relative bg-white dark:bg-[#11161D]/80 backdrop-blur-xl border border-zinc-200 dark:border-[rgba(212,175,55,0.15)] rounded-2xl p-6 shadow-2xl space-y-4">
                <h4 className="font-bold text-zinc-900 dark:text-[#EAEAEA] text-sm flex items-center gap-2">
                ...
                {[
                  ...
                  <div key={i} className="bg-[#0B0E13] border border-zinc-200 dark:border-[rgba(212,175,55,0.15)] rounded-2xl p-4 space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-bold text-zinc-900 dark:text-[#EAEAEA]">{g.label}</span>
            ...
            <div className="order-1 lg:order-2 space-y-5">
              ...
              <div className="bg-[#0B0E13]/50 border border-zinc-200 dark:border-[rgba(212,175,55,0.15)] rounded-2xl px-5 py-4">
                <p className="text-sm text-zinc-900 dark:text-[#EAEAEA] leading-relaxed font-medium italic">
      ...
      {/* ═══════════════════════════════════════
          7. PRICING
         ═══════════════════════════════════════ */}
      <section id="pricing" className="py-10 md:py-14 px-6 relative z-10 overflow-hidden border-t border-zinc-200 dark:border-[#111827]">
        <div className="max-w-4xl mx-auto">
          <div className="reveal text-center space-y-4 mb-12">
            ...
            <p className="text-zinc-600 dark:text-[#A0A0A0] text-lg">Choose a path that fits your trading journey.</p>
          </div>

          <div className="reveal grid grid-cols-1 md:grid-cols-2 gap-8 relative">
            {/* Free Plan */}
            <div className="bg-white dark:bg-[#11161D]/60 backdrop-blur-sm border border-zinc-200 dark:border-[rgba(212,175,55,0.15)] p-8 rounded-[2rem] space-y-8 flex flex-col group hover:border-zinc-200 dark:border-[#111827] transition-all duration-300">
              <div className="space-y-2">
                <h3 className="text-lg font-bold text-zinc-600 dark:text-[#A0A0A0]">Standard Plan</h3>
                <p className="text-3xl font-black italic">Free <span className="text-sm text-zinc-600 dark:text-[#A0A0A0] font-medium not-italic">/ forever</span></p>
              </div>
              ...
              <Link href="/signup?plan=free"
                className="w-full py-4 bg-zinc-200 dark:bg-zinc-800/80 hover:bg-zinc-700 text-zinc-900 dark:text-[#EAEAEA] font-bold rounded-2xl transition-all text-center block">
                Start Free Plan
              </Link>
            </div>
            ...
            <div className="bg-gradient-to-b from-[#11161D] to-[#0D1218] border-2 border-[#D4AF37]/20 p-8 rounded-[2rem] space-y-8 relative overflow-hidden flex flex-col shadow-[0_0_60px_rgba(212,175,55,0.05)] transform md:-translate-y-4 hover:border-[#D4AF37]/40 transition-all duration-300">
              ...
              <div className="space-y-2">
                ...
                <p className="text-3xl font-black">$2.99 <span className="text-sm text-zinc-600 dark:text-[#A0A0A0] font-medium">/ month</span></p>
                <p className="text-sm font-bold text-zinc-600 dark:text-[#A0A0A0]">or <span className="text-zinc-900 dark:text-[#EAEAEA]">$19.99</span> / year</p>
              </div>
              <ul className="space-y-4 flex-1">
              ...
              <div className="space-y-3">
                ...
                <Link href="/demo" className="w-full py-3 border border-zinc-200 dark:border-[rgba(212,175,55,0.15)] text-zinc-900 dark:text-[#EAEAEA] font-bold rounded-2xl hover:bg-white/5 transition-all flex items-center justify-center gap-2">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="reveal grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              ...
              <div key={i}
                className="group relative bg-white dark:bg-[#11161D]/60 backdrop-blur-sm border border-zinc-200 dark:border-[rgba(212,175,55,0.15)] rounded-2xl p-6 hover:border-white/15 transition-all duration-300 hover:-translate-y-1">
                ...
                <p className="text-sm text-zinc-900 dark:text-[#EAEAEA] leading-relaxed">
      ...
      <section className="py-10 md:py-14 px-6 relative z-10">
        <div className="reveal max-w-4xl mx-auto relative">
          ...
          <div className="relative bg-white dark:bg-[#11161D]/60 backdrop-blur-xl border border-white/8 rounded-[3rem] p-10 md:p-14 text-center space-y-6 overflow-hidden">
            ...
            <div className="relative z-10 space-y-4 pt-6">
              <h2 className="text-3xl md:text-5xl font-black tracking-tight text-zinc-900 dark:text-[#EAEAEA] leading-tight">
                Stop Trading Blind.
              </h2>
              <p className="text-zinc-600 dark:text-[#A0A0A0] max-w-xl mx-auto text-lg leading-relaxed">
      ...
      <footer className="border-t border-zinc-200 dark:border-[#111827] py-12 px-6 relative z-10">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-6 text-xs text-zinc-600">
            <Link href="/terms" className="hover:text-zinc-600 dark:text-[#A0A0A0] transition-colors">Terms</Link>
            <Link href="/privacy" className="hover:text-zinc-600 dark:text-[#A0A0A0] transition-colors">Privacy</Link>
...
function PricingTier({ feature, pro = false }: { feature: string; pro?: boolean }) {
  return (
    <li className="flex items-center gap-3">
      <div className={`w-5 h-5 rounded-full flex items-center justify-center shrink-0 ${pro ? "bg-[#D4AF37]/20 text-[#D4AF37]" : "bg-zinc-200 dark:bg-zinc-800 text-zinc-600 dark:text-[#A0A0A0]"}`}>
        <Check size={14} strokeWidth={3} />
      </div>
      <span className={`text-sm ${pro ? "text-zinc-200 font-bold" : "text-zinc-600 dark:text-[#A0A0A0]"}`}>{feature}</span>
    </li>
  );
}
...
function PricingLocked({ feature }: { feature: string }) {
  return (
    <li className="flex items-center gap-3 opacity-30 select-none">
      <div className="w-5 h-5 rounded-full border border-zinc-200 dark:border-[rgba(212,175,55,0.15)] flex items-center justify-center shrink-0">
        <Lock size={10} />
      </div>
      <span className="text-xs text-zinc-600 dark:text-[#A0A0A0] line-through">{feature}</span>
    </li>
  );
}
