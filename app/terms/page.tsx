  ...
  return (
    <div className="min-h-screen bg-black text-zinc-300 p-8 md:p-16 max-w-4xl mx-auto selection:bg-emerald-500/30 animate-in fade-in duration-500">
      <div className="mb-10">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-white mt-4 mb-2 tracking-tight">Terms of Service</h1>
        <p className="text-zinc-500 font-medium">Last Updated: March 2026</p>
      </div>

      <div className="space-y-10 text-base leading-relaxed">
        <section>
          <h2 className="text-2xl font-semibold text-emerald-400 mb-3">1. Welcome to TradeJournal</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-emerald-400 mb-3">2. Not Financial Advice</h2>
          <div className="p-5 bg-red-500/10 border border-red-500/20 rounded-xl text-red-200">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-emerald-400 mb-3">3. Your Data & Authentication</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-emerald-400 mb-3">4. Acceptable Use</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-emerald-400 mb-3">5. Service Availability</h2>
