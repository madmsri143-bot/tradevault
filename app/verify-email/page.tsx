      ...
      <div className="max-w-md w-full bg-zinc-900 border border-black/10 dark:border-white/5 fade-slide-up shadow-[0_1px_2px_rgba(0,0,0,0.05)] dark:shadow-none p-8 rounded-2xl shadow-xl text-center space-y-6 animate-in slide-in-from-bottom-4 fade-in duration-700">
        ...
        <div className="space-y-3 pt-4 border-t border-white/5">
          ...
          <button 
            ...
            className="w-full bg-zinc-800 hover:bg-zinc-700 text-white font-semibold py-3.5 px-4 rounded-xl transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-50"
          >
          ...
          <button 
            ...
            className="w-full bg-transparent hover:bg-white/5 text-zinc-400 hover:text-white font-semibold py-3.5 px-4 rounded-xl transition-all flex items-center justify-center gap-2"
          >
            <ArrowLeft size={18} />
            Back to Login
          </button>
