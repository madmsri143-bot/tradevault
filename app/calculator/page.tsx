...
function PipValueCalculator() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in zoom-in-95 duration-500">
      ...
      <p className="text-xs text-[#A0A0A0] mt-6 text-center font-medium max-w-lg mx-auto">Measures the explicit absolute monetary value of the distance between two price points given your selected lot size/quantity.</p>
    </div>
  );
}
    ...
    <div className="space-y-8 animate-in fade-in zoom-in-95 duration-500">
      ...
      {result && !result.error && (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <div className="p-5 rounded-2xl bg-black/20 border border-[rgba(212,175,55,0.15)] relative overflow-hidden group hover:-translate-y-[2px] hover:border-[rgba(212,175,55,0.25)] hover:shadow-[0_8px_32px_rgba(212,175,55,0.1),inset_0_1px_0_rgba(255,255,255,0.02)] transition-all duration-300">
             <div className="relative z-10 text-[10px] font-black uppercase tracking-widest text-[#A0A0A0] mb-1">Risk Amount</div>
             <div className="relative z-10 text-2xl font-black text-[#EAEAEA]">{formatMoney(result.riskAmount)}</div>
          </div>
          <div className="p-5 rounded-2xl bg-black/20 border border-[rgba(212,175,55,0.15)] relative overflow-hidden group hover:-translate-y-[2px] hover:border-[rgba(212,175,55,0.25)] hover:shadow-[0_8px_32px_rgba(212,175,55,0.1),inset_0_1px_0_rgba(255,255,255,0.02)] transition-all duration-300">
