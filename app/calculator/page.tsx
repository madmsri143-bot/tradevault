  ...
  return (
    <div className="relative group">
      <input 
        ...
        className="peer w-full bg-zinc-50 dark:bg-[#0B0F14]/50 border border-zinc-200 dark:border-[rgba(212,175,55,0.15)] rounded-2xl px-4 pt-6 pb-2 text-sm text-zinc-900 dark:text-[#EAEAEA] focus:outline-none focus:ring-2 focus:ring-[#D4AF37]/20 focus:border-[#D4AF37]/50 transition-all hover:bg-white/5 shadow-inner" 
      />
      <label 
  ...
  return (
    <div className="relative group">
      <select 
        ...
        className="peer w-full bg-zinc-50 dark:bg-[#0B0F14]/50 border border-zinc-200 dark:border-[rgba(212,175,55,0.15)] rounded-2xl px-4 pt-6 pb-2 text-sm text-zinc-900 dark:text-[#EAEAEA] focus:outline-none focus:ring-2 focus:ring-[#D4AF37]/20 focus:border-[#D4AF37]/50 transition-all hover:bg-white/5 appearance-none shadow-inner" 
      >
        {options.map((opt: any) => (
          <option key={opt.value || opt} value={opt.value || opt} className="bg-black text-zinc-900 dark:text-[#EAEAEA]">{opt.label || opt}</option>
        ))}
      </select>
      <label 
        htmlFor={`select-${label.replace(/[\s/()]+/g, '-')}`}
        className="absolute left-4 top-4 text-[10px] -translate-y-2.5 font-bold uppercase tracking-widest text-zinc-600 dark:text-[#A0A0A0] transition-all duration-200 peer-focus:text-[#D4AF37] pointer-events-none"
      >
        {label}
      </label>
      <div className="absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none text-zinc-600 dark:text-[#A0A0A0] group-hover:text-[#D4AF37] transition-colors">
        <ChevronDown size={14} />
      </div>
    </div>
  );
...
export default function CalculatorPage() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700 max-w-5xl mx-auto pb-20 mt-4 px-4 sm:px-0">
      <div className="text-center sm:text-left flex flex-col sm:flex-row items-center gap-6 mb-8 border-b border-zinc-200 dark:border-[#111827] pb-6 group">
        <div className="p-4 bg-[#D4AF37]/10 rounded-2xl border border-[#D4AF37]/20 shadow-[0_0_30px_rgba(212,175,55,0.15)] group-hover:scale-105 group-hover:shadow-[0_0_40px_rgba(212,175,55,0.25)] transition-all duration-500">
        ...
        <div>
          ...
          <p className="text-zinc-600 dark:text-[#A0A0A0] font-medium text-lg">Manage risk, size positions, and calculate your edge.</p>
        </div>
      </div>
...
function PnLCalculator() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in zoom-in-95 duration-500">
      ...
      {result && result.error && (
        <div className="p-4 rounded-2xl border bg-red-500/10 border-red-500/20 text-red-500 font-bold text-sm animate-in zoom-in-95">
          {result.message}
        </div>
      )}
      ...
      {result && !result.error && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="p-6 rounded-2xl bg-black/20 border border-zinc-200 dark:border-[rgba(212,175,55,0.15)] relative overflow-hidden group hover:-translate-y-[2px] hover:border-[rgba(212,175,55,0.25)] hover:shadow-[0_8px_32px_rgba(212,175,55,0.1),inset_0_1px_0_rgba(255,255,255,0.02)] transition-all duration-300">
            <div className="absolute inset-0 bg-gradient-to-br from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            <div className="relative z-10 text-xs font-black uppercase tracking-widest text-zinc-600 dark:text-[#A0A0A0] mb-2">{getUnitName(instrument)} Output</div>
          ...
          <div className={`p-6 rounded-2xl border flex flex-col justify-center relative overflow-hidden group ${result.pnl >= 0 ? "bg-[#10B981]/10 border-[#10B981]/30" : "bg-[#FF4D6D]/10 border-[#FF4D6D]/30"}`}>
            ...
            <div className="relative z-10 text-xs font-black uppercase tracking-widest mb-2 opacity-60 text-zinc-900 dark:text-[#EAEAEA]">{result.pnl >= 0 ? "Profit" : "Loss"}</div>
    ...
    <div className="space-y-8 animate-in fade-in zoom-in-95 duration-500">
      ...
      {result !== null && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="p-6 rounded-2xl bg-black/20 border border-zinc-200 dark:border-[rgba(212,175,55,0.15)] relative overflow-hidden group hover:-translate-y-[2px] hover:border-[rgba(212,175,55,0.25)] hover:shadow-[0_8px_32px_rgba(212,175,55,0.1),inset_0_1px_0_rgba(255,255,255,0.02)] transition-all duration-300">
            <div className="absolute inset-0 bg-gradient-to-br from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            <div className="relative z-10 text-xs font-black uppercase tracking-widest text-zinc-600 dark:text-[#A0A0A0] mb-2">Risk Amount</div>
            <div className="relative z-10 text-3xl font-black text-zinc-900 dark:text-[#EAEAEA]">{formatMoney(result.riskAmount)}</div>
          </div>
    ...
    <div className="space-y-8 animate-in fade-in zoom-in-95 duration-500">
      ...
      {result && !result.error && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="p-6 rounded-2xl bg-black/20 border border-zinc-200 dark:border-[rgba(212,175,55,0.15)] relative overflow-hidden group hover:-translate-y-[2px] hover:border-[rgba(212,175,55,0.25)] hover:shadow-[0_8px_32px_rgba(212,175,55,0.1),inset_0_1px_0_rgba(255,255,255,0.02)] transition-all duration-300">
            <div className="absolute inset-0 bg-gradient-to-br from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            <div className="relative z-10 text-xs font-black uppercase tracking-widest text-zinc-600 dark:text-[#A0A0A0] mb-2">{unitName} Movement</div>
      ...
      <p className="text-xs text-zinc-600 dark:text-[#A0A0A0] mt-6 text-center font-medium max-w-lg mx-auto">Measures the explicit absolute monetary value of the distance between two price points given your selected lot size/quantity.</p>
    </div>
  );
}
      ...
      {result && !result.error && (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className={`p-5 rounded-2xl border flex flex-col justify-center relative overflow-hidden group md:col-span-2 lg:col-span-1 ${result.pnl >= 0 ? "bg-[#10B981]/10 border-[#10B981]/30" : "bg-[#FF4D6D]/10 border-[#FF4D6D]/30"}`}>
             <div className="absolute inset-0 bg-gradient-to-br from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
             <div className="relative z-10 text-[10px] font-black uppercase tracking-widest text-zinc-900 dark:text-[#EAEAEA]/50 mb-1">Est PnL</div>
          ...
          <div className="p-5 rounded-2xl bg-black/20 border border-zinc-200 dark:border-[rgba(212,175,55,0.15)] relative overflow-hidden group hover:-translate-y-[2px] hover:border-[rgba(212,175,55,0.25)] hover:shadow-[0_8px_32px_rgba(212,175,55,0.1),inset_0_1px_0_rgba(255,255,255,0.02)] transition-all duration-300">
             <div className="relative z-10 text-[10px] font-black uppercase tracking-widest text-zinc-600 dark:text-[#A0A0A0] mb-1">{getUnitName(instrument)} Gained</div>
          ...
          <div className="p-5 rounded-2xl bg-black/20 border border-zinc-200 dark:border-[rgba(212,175,55,0.15)] relative overflow-hidden group hover:-translate-y-[2px] hover:border-[rgba(212,175,55,0.25)] hover:shadow-[0_8px_32px_rgba(212,175,55,0.1),inset_0_1px_0_rgba(255,255,255,0.02)] transition-all duration-300">
             <div className="relative z-10 text-[10px] font-black uppercase tracking-widest text-zinc-600 dark:text-[#A0A0A0] mb-1">Risk Amount</div>
             <div className="relative z-10 text-2xl font-black text-zinc-900 dark:text-[#EAEAEA]">{formatMoney(result.riskAmount)}</div>
          </div>
          <div className="p-5 rounded-2xl bg-black/20 border border-zinc-200 dark:border-[rgba(212,175,55,0.15)] relative overflow-hidden group hover:-translate-y-[2px] hover:border-[rgba(212,175,55,0.25)] hover:shadow-[0_8px_32px_rgba(212,175,55,0.1),inset_0_1px_0_rgba(255,255,255,0.02)] transition-all duration-300">
             <div className="relative z-10 text-[10px] font-black uppercase tracking-widest text-zinc-600 dark:text-[#A0A0A0] mb-1">Reward Ratio</div>
