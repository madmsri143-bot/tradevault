...
export default function AIScoreCard({ data }: { data: any }) {
  ...
  return (
    <div className="bg-[#111] border border-[#222] rounded-2xl p-6 shadow-2xl relative overflow-hidden">
      ...
      <h2 className="text-xs font-black uppercase tracking-widest text-[#A0A0A0] mb-4 flex items-center gap-2">
      ...
      <div className="space-y-4 text-sm text-[#EAEAEA]">
        <div className="bg-[#1a1a1a] p-3.5 rounded-2xl border border-[rgba(212,175,55,0.15)] flex gap-3 shadow-inner">
