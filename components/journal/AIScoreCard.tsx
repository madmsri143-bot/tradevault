...
export default function AIScoreCard({ data }: { data: any }) {
  ...
  return (
    <div className="bg-[#111] border border-[#222] rounded-2xl p-6 shadow-2xl relative overflow-hidden">
      ...
      <h2 className="text-xs font-black uppercase tracking-widest text-zinc-600 dark:text-[#A0A0A0] mb-4 flex items-center gap-2">
      ...
      <div className="space-y-4 text-sm text-zinc-900 dark:text-[#EAEAEA]">
        <div className="bg-[#1a1a1a] p-3.5 rounded-2xl border border-zinc-200 dark:border-[rgba(212,175,55,0.15)] flex gap-3 shadow-inner">
          <div className="mt-0.5"><span className="text-red-600 dark:text-red-400">⚠</span></div>
        ...
        <div className="bg-[#1a1a1a] p-3.5 rounded-2xl border border-zinc-200 dark:border-[rgba(212,175,55,0.15)] flex gap-3 shadow-inner">
          <div className="mt-0.5"><span className="text-emerald-600 dark:text-emerald-400">🚀</span></div>
          <div className="flex flex-col">
