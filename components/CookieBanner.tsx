...
export default function CookieBanner() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[100] w-full bg-[#1F2937]/95 backdrop-blur-md border-t border-[#111827] shadow-[0_-4px_24px_rgba(0,0,0,0.4)] animate-in slide-in-from-bottom-full duration-500">
      <div className="max-w-7xl mx-auto px-4 md:px-6 h-auto md:h-16 py-4 md:py-0 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <p className="text-sm font-medium text-[#E5E7EB] text-center md:text-left">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          <button 
            ...
            className="flex-1 md:flex-none px-5 py-2 text-sm font-medium text-[#9CA3AF] bg-transparent border border-zinc-700 hover:border-zinc-500 hover:text-zinc-200 rounded-lg transition-colors"
          >
            Reject All
          </button>
          <button 
