...
export default function Topbar() {
  ...
  return (
    <div className="w-full h-16 shrink-0 bg-transparent flex items-center justify-between px-4 md:px-8 relative z-50">
      ...
      >
        <span className="text-[#00FFB2] font-black">J</span>
        <span className="text-zinc-950 dark:text-white font-bold">ournal</span>
        <span className="text-[#00FFB2] font-black">B</span>
        <span className="text-zinc-950 dark:text-white font-bold">ud</span>
      </h1>
