  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500 pb-10">
        ...
        {/* ═══════════════════════════════════════════════
           ...
           ═══════════════════════════════════════════════ */}
        <div className="bg-zinc-900 border border-black/10 dark:border-white/5 fade-slide-up shadow-[0_4px_20px_rgba(0,0,0,0.2)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.5)] p-6 md:p-8 rounded-2xl flex flex-col w-full relative z-10 transition-colors hover:border-white/10 mt-6">
