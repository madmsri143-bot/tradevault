...
const CustomBarTooltip = ({ active, payload, displayCurrency }: any) => {
  if (active && payload && payload.length) {
    return (
      <div className="bg-[#09090b] border border-zinc-200 dark:border-[#27272a] rounded shadow-sm shadow-black/80 px-2 py-1.5 min-w-[50px] flex flex-col items-center">
        <p className="text-[11px] text-zinc-600 dark:text-[#A0A0A0] font-medium tracking-tight mb-0.5 leading-none">{payload[0].payload.name}</p>
        <p className="text-[13.5px] font-bold text-zinc-900 dark:text-[#EAEAEA] tracking-tight leading-none">
  ...
  return (
    <div className="flex flex-col gap-8 mb-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="flex gap-4 text-xs text-zinc-600 dark:text-[#A0A0A0] mt-2">
      ...
      <div className="bg-white dark:bg-gradient-to-b dark:from-[#0A0A0A] dark:to-[#121212] backdrop-blur-md border border-zinc-200 dark:border-[rgba(212,175,55,0.15)] fade-slide-up shadow-md dark:shadow-[0_4px_24px_rgba(0,0,0,0.6),inset_0_1px_0_rgba(255,255,255,0.02)] p-6 md:p-8 rounded-2xl flex flex-col items-center justify-between min-h-[360px] cursor-default hover:-translate-y-[2px] hover:border-[rgba(212,175,55,0.25)] hover:shadow-[0_8px_32px_rgba(212,175,55,0.1),inset_0_1px_0_rgba(255,255,255,0.02)] transition-all duration-300">
        <h3 className="text-[13px] font-bold tracking-wide uppercase text-zinc-600 dark:text-[#A0A0A0] w-full mb-6">Consistency Tracking</h3>
        
        {trades.length === 0 ? (
          <div className="flex-1 flex items-center justify-center text-zinc-600 dark:text-[#A0A0A0] text-sm italic text-center px-4 leading-relaxed">
          ...
          <div className="w-full flex-1 flex flex-col justify-center items-center gap-6">
            <div className="flex flex-col items-center">
              <span className="text-xs text-zinc-600 dark:text-[#A0A0A0] font-medium mb-1.5 uppercase tracking-widest">Current Streak</span>
              <div className={`text-4xl font-bold flex items-center gap-3 ${currentStreak > 0 ? "text-emerald-500 drop-shadow-[0_0_12px_rgba(16,185,129,0.3)]" : "text-zinc-600 dark:text-[#A0A0A0]"}`}>
                <span>{currentStreak > 0 ? "🔥" : "❄️"}</span>
                {currentStreak} <span className="text-lg">Day{currentStreak !== 1 ? 's' : ''}</span>
              </div>
            </div>

            <div className="w-full max-w-[240px] bg-white dark:bg-gradient-to-b dark:from-[#0A0A0A] dark:to-[#121212] backdrop-blur-md p-4 rounded-2xl border border-zinc-200 dark:border-[rgba(212,175,55,0.15)] shadow-md dark:shadow-[0_4px_24px_rgba(0,0,0,0.6),inset_0_1px_0_rgba(255,255,255,0.02)] shadow-inner">
              ...
              {(greenDays > 0 || redDays > 0) && (
                <div className="w-full h-2 bg-zinc-200 dark:bg-zinc-800 rounded-full mt-4 overflow-hidden flex shadow-inner">
      ...
      <div className="bg-white dark:bg-gradient-to-b dark:from-[#0A0A0A] dark:to-[#121212] backdrop-blur-md border border-zinc-200 dark:border-[rgba(212,175,55,0.15)] fade-slide-up shadow-md dark:shadow-[0_4px_24px_rgba(0,0,0,0.6),inset_0_1px_0_rgba(255,255,255,0.02)] p-6 md:p-8 rounded-2xl flex flex-col w-full relative z-10 transition-colors hover:border-zinc-200 dark:border-[#111827]">
        ...
        {trades.length === 0 ? (
          <div className="flex-1 flex items-center justify-center text-zinc-600 dark:text-[#A0A0A0] text-sm h-[250px] italic bg-white dark:bg-gradient-to-b dark:from-[#0A0A0A] dark:to-[#121212] backdrop-blur-md rounded-lg border border-zinc-200 dark:border-[rgba(212,175,55,0.15)] shadow-md dark:shadow-[0_4px_24px_rgba(0,0,0,0.6),inset_0_1px_0_rgba(255,255,255,0.02)]">
