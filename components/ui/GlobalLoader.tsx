  ...
  return (
    <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-[#0B0F14] animate-in fade-in duration-500">
      ...
      <div className="relative flex flex-col items-center gap-6">
        <div className="w-20 h-20 bg-gradient-to-br from-[#11161D] to-[#0D1218] rounded-[24px] border border-[#D4AF37]/20 flex items-center justify-center shadow-[0_0_40px_rgba(201,166,70,0.1)] animate-bounce-subtle">
          <JBLogo size={40} />
        </div>
