  ...
  return (
    <div className="mt-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          {currentPlan === "pro_monthly" && (
            <div className="absolute top-4 right-4 bg-[#D4AF37]/20 text-[#D4AF37] text-xs font-bold px-3 py-1 rounded-full flex items-center gap-1.5">
        ...
        <div 
          ...
          className={`relative p-8 rounded-2xl border transition-all cursor-pointer transform md:-translate-y-2 flex flex-col ${
            currentPlan === "pro_yearly" 
              ? "bg-[#D4AF37]/10 border-[#D4AF37] shadow-[0_0_30px_rgba(212,175,55,0.2)]" 
              : "bg-gradient-to-br from-black/40 to-[#D4AF37]/5 border-[#D4AF37]/30 hover:border-[#D4AF37]/60"
          }`}
        >
          <div className="absolute top-0 right-1/2 translate-x-1/2 -translate-y-1/2 bg-black border border-[#D4AF37]/50 text-[#D4AF37] text-[10px] font-black uppercase tracking-[0.2em] px-4 py-1.5 rounded-full shadow-[0_0_15px_rgba(212,175,55,0.4)]">
          ...
          <ul className="space-y-4 text-sm text-zinc-100 flex-1">
            <li className="flex items-center gap-3"><CheckCircle2 size={16} className="text-[#D4AF37]" /> Everything in Pro Starter, plus:</li>
            <li className="flex items-center gap-3"><CheckCircle2 size={16} className="text-[#D4AF37]" /> Long-Term Pattern Recognition</li>
            <li className="flex items-center gap-3"><CheckCircle2 size={16} className="text-[#D4AF37]" /> 40% Annual Discount</li>
            <li className="flex items-center gap-3"><CheckCircle2 size={16} className="text-[#D4AF37]" /> Priority Infrastructure</li>
          </ul>
        </div>
      </div>
    </div>
